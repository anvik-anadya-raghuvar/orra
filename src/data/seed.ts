...
function rawSeed(): Dataset {
  return {
    ...
    ranking_weights: { id: 1, priority: 40, unblocks: 30, deadline: 30, updated_at: T('2026-08-01T09:00:00') },
    tags: [
    ...
    /* No seeded files: they would need real bytes in the bucket to be
    ...
    people: [
      { id: 'p-1', name: 'Ludhiana Steel', role: 'Pilot customer', relationship_type: 'customer', project_id: 'anvik', time_zone: 'Asia/Kolkata', cadence_days: 14, last_contact_date: D('2026-08-10'), next_action: 'Send September pricing', notes: 'Prefers WhatsApp. Decision maker: Mr. Arora.', email: 'procurement@ludhianasteel.in', phone: '+91 161 244 8890', company: 'Ludhiana Steel Rolling Mills Pvt Ltd', created_at: T('2026-06-15T09:00:00') },
      { id: 'p-2', name: 'Surat Textiles', role: 'Vendor · rain gear', relationship_type: 'vendor', project_id: 'con', time_zone: 'Asia/Kolkata', cadence_days: 7, last_contact_date: D('2026-08-16'), next_action: 'Chase revised MOQ', notes: 'Negotiable on advance.', email: 'sales@surattextiles.in', phone: '+91 98250 41122', company: 'Surat Textiles Pvt Ltd', created_at: T('2026-07-20T09:00:00') },
      { id: 'p-3', name: 'Prof. Bianchi', role: 'Politecnico · supervisor', relationship_type: 'university', project_id: 'personal', time_zone: 'Europe/Rome', cadence_days: 30, last_contact_date: null, next_action: 'Introduce yourself before term', notes: 'Works on interpretability. Read two papers first.', email: 'bianchi@polimi.it', phone: '+39 02 2399 1234', company: 'Politecnico di Milano', created_at: T('2026-08-01T09:00:00') },
      { id: 'p-4', name: 'R. Mehta', role: 'Angel · warm intro', relationship_type: 'investor', project_id: 'anvik', time_zone: 'Asia/Kolkata', cadence_days: 21, last_contact_date: D('2026-07-26'), next_action: 'Share the traction one-pager', notes: 'Asked about the PD dataset moat.', email: 'r.mehta@mehtaventures.com', phone: '+91 98110 22733', company: 'Mehta Ventures', created_at: T('2026-07-01T09:00:00') },
      { id: 'p-5', name: 'CA Sharma', role: 'Compliance', relationship_type: 'vendor', project_id: 'anvik', time_zone: 'Asia/Kolkata', cadence_days: 30, last_contact_date: D('2026-08-13'), next_action: 'Q2 filings confirmation', notes: '', email: 'sharma@sharmaassociates.co.in', phone: '+91 98765 12340', company: 'Sharma & Associates', created_at: T('2026-06-01T09:00:00') },
      { id: 'p-6', name: 'Milan housing agent', role: 'Relocation', relationship_type: 'personal', project_id: 'personal', time_zone: 'Europe/Rome', cadence_days: 3, last_contact_date: D('2026-08-17'), next_action: 'Confirm viewing slot', notes: 'Two flats near Bovisa. Budget €800.', email: '', phone: '+39 340 118 2255', company: '', created_at: T('2026-08-05T09:00:00') },
    ],
    people_interactions: [
